...
export const ContainerScroll: React.FC<ContainerScrollProps> = ({
  ...
  return (
    <div
      className="h-[60rem] md:h-[80rem] flex items-center justify-center relative p-2 md:p-20 bg-gradient-to-b from-gray-50 to-white dark:from-black dark:to-gray-900"
      ref={containerRef}
    >
      <div
